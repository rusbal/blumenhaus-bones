...
class PayEngineCw_Dispatcher
{
	...
	public function dispatch() {
		try {
			$request = PayEngineCw_ContextRequest::getInstance();
	...
	private function getControllerInstance() {
		...
		$expectedClassName = 'PayEngineCw_Controller_' . Customweb_Core_Util_String::ucFirst($this->controllerName);
		$effectiveClass = null;
