...
class PayEngineCw_PaymentMethodWrapper implements Customweb_Payment_Authorization_IPaymentMethod {
	...
	/**
	 * @var PayEngineCw_PaymentMethod
	 */
	private $method = null;
	
	public function __construct(PayEngineCw_PaymentMethod $method) {
	...
	protected function getMethod() {
		if ($this->method === null) {
			...
			PayEngineCw_Util::includePaymentMethod($paymentMethod);
