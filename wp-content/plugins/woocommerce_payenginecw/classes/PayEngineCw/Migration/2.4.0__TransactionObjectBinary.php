...
class PayEngineCw_Migration_2_4_0 implements Customweb_Database_Migration_IScript {
	...
	public function execute(Customweb_Database_IDriver $driver){
		...
		if ($result->getRowCount() <= 0) {
			$driver->query("ALTER TABLE `" . $tableNameTransaction . "` ADD  `transactionObjectBinary` BLOB NULL")->execute();
		}
		$driver->query("CREATE TABLE IF NOT EXISTS `" . $wpdb->prefix . "woocommerce_payenginecw_documents` (
