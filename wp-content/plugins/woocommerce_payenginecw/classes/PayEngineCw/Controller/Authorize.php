 ...
 *
 */
class PayEngineCw_Controller_Authorize extends PayEngineCw_Controller_Abstract {
	...
	public function indexAction() {
		...
		PayEngineCw_Util::getTransactionHandler()->persistTransactionObject($transactionObject);
