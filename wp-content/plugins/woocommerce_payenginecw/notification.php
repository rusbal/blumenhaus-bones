 ...
 *
* For backwards compatibility only, notification processing for existing configurations
*/
...
$response = $dispatcher->invokeControllerAction($httpRequest, 'process', 'index');
