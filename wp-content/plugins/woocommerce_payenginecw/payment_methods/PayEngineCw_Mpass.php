...
class PayEngineCw_Mpass extends PayEngineCw_PaymentMethod
{
	public $machineName = 'mpass';
	public $admin_title = 'mpass';
	public $title = 'mpass';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_payenginecw_mpass_icon', 
			PayEngineCw_Util::getResourcesUrl('icons/mpass.png')
		);
		parent::__construct();
	}
