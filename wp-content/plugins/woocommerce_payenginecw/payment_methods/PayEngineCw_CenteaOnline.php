...
class PayEngineCw_CenteaOnline extends PayEngineCw_PaymentMethod
{
	public $machineName = 'centeaonline';
	public $admin_title = 'CENTEA Online';
	public $title = 'CENTEA Online';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_payenginecw_centeaonline_icon', 
			PayEngineCw_Util::getResourcesUrl('icons/centeaonline.png')
		);
		parent::__construct();
	}
