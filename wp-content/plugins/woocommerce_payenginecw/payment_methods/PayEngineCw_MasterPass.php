...
class PayEngineCw_MasterPass extends PayEngineCw_PaymentMethod
{
	public $machineName = 'masterpass';
	public $admin_title = 'MasterPass';
	public $title = 'MasterPass';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_payenginecw_masterpass_icon', 
			PayEngineCw_Util::getResourcesUrl('icons/masterpass.png')
		);
		parent::__construct();
	}
