...
class PayEngineCw_PostFinanceEFinance extends PayEngineCw_PaymentMethod
{
	public $machineName = 'postfinanceefinance';
	public $admin_title = 'PostFinance E-Finance';
	public $title = 'PostFinance E-Finance';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_payenginecw_postfinanceefinance_icon', 
			PayEngineCw_Util::getResourcesUrl('icons/postfinanceefinance.png')
		);
		parent::__construct();
	}
