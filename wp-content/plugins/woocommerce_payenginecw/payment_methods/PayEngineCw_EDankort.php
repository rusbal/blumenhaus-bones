...
class PayEngineCw_EDankort extends PayEngineCw_PaymentMethod
{
	public $machineName = 'edankort';
	public $admin_title = 'eDankort';
	public $title = 'eDankort';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_payenginecw_edankort_icon', 
			PayEngineCw_Util::getResourcesUrl('icons/edankort.png')
		);
		parent::__construct();
	}
