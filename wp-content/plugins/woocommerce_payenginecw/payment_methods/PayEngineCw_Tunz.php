...
class PayEngineCw_Tunz extends PayEngineCw_PaymentMethod
{
	public $machineName = 'tunz';
	public $admin_title = 'TUNZ';
	public $title = 'TUNZ';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_payenginecw_tunz_icon', 
			PayEngineCw_Util::getResourcesUrl('icons/tunz.png')
		);
		parent::__construct();
	}
