...
class PayEngineCw_BelfiusDirectNet extends PayEngineCw_PaymentMethod
{
	public $machineName = 'belfiusdirectnet';
	public $admin_title = 'Belfius Direct Net';
	public $title = 'Belfius Direct Net';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_payenginecw_belfiusdirectnet_icon', 
			PayEngineCw_Util::getResourcesUrl('icons/belfiusdirectnet.png')
		);
		parent::__construct();
	}
