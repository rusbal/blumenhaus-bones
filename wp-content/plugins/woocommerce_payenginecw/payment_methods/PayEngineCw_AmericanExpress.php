...
class PayEngineCw_AmericanExpress extends PayEngineCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_payenginecw_americanexpress_icon', 
			PayEngineCw_Util::getResourcesUrl('icons/americanexpress.png')
		);
		parent::__construct();
	}
