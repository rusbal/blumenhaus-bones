...
class PayEngineCw_Dankort extends PayEngineCw_PaymentMethod
{
	public $machineName = 'dankort';
	public $admin_title = 'Dankort';
	public $title = 'Dankort';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_payenginecw_dankort_icon', 
			PayEngineCw_Util::getResourcesUrl('icons/dankort.png')
		);
		parent::__construct();
	}
