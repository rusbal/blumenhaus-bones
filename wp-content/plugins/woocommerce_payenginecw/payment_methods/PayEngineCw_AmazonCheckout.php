...
class PayEngineCw_AmazonCheckout extends PayEngineCw_PaymentMethod
{
	public $machineName = 'amazoncheckout';
	public $admin_title = 'Amazon Payments';
	public $title = 'Amazon Payments';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_payenginecw_amazoncheckout_icon', 
			PayEngineCw_Util::getResourcesUrl('icons/amazoncheckout.png')
		);
		parent::__construct();
	}
