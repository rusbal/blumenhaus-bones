...
class PayEngineCw_Giropay extends PayEngineCw_PaymentMethod
{
	public $machineName = 'giropay';
	public $admin_title = 'giropay';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_payenginecw_giropay_icon', 
			PayEngineCw_Util::getResourcesUrl('icons/giropay.png')
		);
		parent::__construct();
	}
