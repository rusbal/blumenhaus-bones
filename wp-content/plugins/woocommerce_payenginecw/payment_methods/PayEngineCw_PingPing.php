...
class PayEngineCw_PingPing extends PayEngineCw_PaymentMethod
{
	public $machineName = 'pingping';
	public $admin_title = 'PingPing';
	public $title = 'PingPing';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_payenginecw_pingping_icon', 
			PayEngineCw_Util::getResourcesUrl('icons/pingping.png')
		);
		parent::__construct();
	}
