...
class PayEngineCw_Eps extends PayEngineCw_PaymentMethod
{
	public $machineName = 'eps';
	public $admin_title = 'EPS';
	public $title = 'EPS';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_payenginecw_eps_icon', 
			PayEngineCw_Util::getResourcesUrl('icons/eps.png')
		);
		parent::__construct();
	}
