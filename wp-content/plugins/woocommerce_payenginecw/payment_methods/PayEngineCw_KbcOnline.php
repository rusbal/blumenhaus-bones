...
class PayEngineCw_KbcOnline extends PayEngineCw_PaymentMethod
{
	public $machineName = 'kbconline';
	public $admin_title = 'KBC Online';
	public $title = 'KBC Online';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_payenginecw_kbconline_icon', 
			PayEngineCw_Util::getResourcesUrl('icons/kbconline.png')
		);
		parent::__construct();
	}
