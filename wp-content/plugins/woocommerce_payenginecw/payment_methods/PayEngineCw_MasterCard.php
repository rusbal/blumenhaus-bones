...
class PayEngineCw_MasterCard extends PayEngineCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_payenginecw_mastercard_icon', 
			PayEngineCw_Util::getResourcesUrl('icons/mastercard.png')
		);
		parent::__construct();
	}
