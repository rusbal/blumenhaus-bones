...
class PayEngineCw_Paysafecard extends PayEngineCw_PaymentMethod
{
	public $machineName = 'paysafecard';
	public $admin_title = 'paysafecard';
	public $title = 'paysafecard';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_payenginecw_paysafecard_icon', 
			PayEngineCw_Util::getResourcesUrl('icons/paysafecard.png')
		);
		parent::__construct();
	}
