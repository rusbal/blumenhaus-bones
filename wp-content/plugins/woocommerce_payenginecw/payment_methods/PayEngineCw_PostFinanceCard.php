...
class PayEngineCw_PostFinanceCard extends PayEngineCw_PaymentMethod
{
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_payenginecw_postfinancecard_icon', 
			PayEngineCw_Util::getResourcesUrl('icons/postfinancecard.png')
		);
		parent::__construct();
	}
