...
class PayEngineCw_Bcmc extends PayEngineCw_PaymentMethod
{
	public $machineName = 'bcmc';
	public $admin_title = 'Bancontact';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_payenginecw_bcmc_icon', 
			PayEngineCw_Util::getResourcesUrl('icons/bcmc.png')
		);
		parent::__construct();
	}
