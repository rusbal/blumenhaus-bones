...
class PayEngineCw_CbcOnline extends PayEngineCw_PaymentMethod
{
	public $machineName = 'cbconline';
	public $admin_title = 'CBC Online';
	public $title = 'CBC Online';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_payenginecw_cbconline_icon', 
			PayEngineCw_Util::getResourcesUrl('icons/cbconline.png')
		);
		parent::__construct();
	}
