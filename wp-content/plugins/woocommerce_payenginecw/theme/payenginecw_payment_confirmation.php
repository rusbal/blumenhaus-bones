<form action="<?php print $form_target_url; ?>" method="post" class="payenginecw-payment-form woocommerce" name="payenginecw-payment-form" id="payenginecw-payment-container" >

	<script type="text/javascript">
		var successCallback = function(valid){
			var formObject = document.getElementById("payenginecw-payment-container");
		...
		if (document.readyState == "complete") {
			(function(){ 
				jQuery('#payenginecw-payment-container').submit(function(event){
	...
	<input type="submit" class="button btn btn-success alt payenginecw-payment-form-confirm" name="submit" id="payenginecw-submit" value="<?php print __("I confirm my payment", "woocommerce_payenginecw"); ?>" />
</form>
