 ...
 *
 */
class Customweb_PayEngine_Container extends Customweb_Payment_AbstractContainer {
	...
	public function getConfiguration(){
		return $this->getBean('Customweb_PayEngine_Configuration');
	}
	...
	public function getMethodFactory(){
		return $this->getBean('Customweb_PayEngine_Method_Factory');
	}
	 ...
	 * @return Customweb_PayEngine_Method_DefaultMethod
	 */
