...
require_once 'Customweb/PayEngine/Method/Invoice/Open/BillPay/LineItemBuilder.php';
 ...
 */
class Customweb_PayEngine_Method_Invoice_Open_BillPay extends Customweb_PayEngine_Method_Invoice_Open_Abstract {
	...
	public function getAuthorizationParameters(Customweb_PayEngine_Authorization_Transaction $transaction, array $formData, $authorizationMethod) {
		...
		$builder = new Customweb_PayEngine_Method_Invoice_Open_BillPay_LineItemBuilder($transaction->getTransactionContext()->getOrderContext());
