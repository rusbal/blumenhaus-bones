...
class Customweb_PayEngine_BackendOperation_Adapter_RefundParameterBuilder extends Customweb_PayEngine_MaintenanceParameterBuilder {
	...
	protected function getOperationParameter() {
		if (Customweb_Payment_Util::amountEqual($this->getTransaction()->getCapturedAmount(), $this->refundAmount) || $this->close) {
			return array('OPERATION' => Customweb_PayEngine_IAdapter::OPERATION_REFUND_FULL);
		}
		else {
			return array('OPERATION' => Customweb_PayEngine_IAdapter::OPERATION_REFUND_PARTIAL);
		}
	}
